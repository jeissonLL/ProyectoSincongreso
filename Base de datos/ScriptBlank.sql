...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_estado_idioma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_estado_idioma` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_estado_idioma` (
  `id_estado_idioma_pk` INT NOT NULL,
  `nombre_estado` VARCHAR(45) NULL,
  PRIMARY KEY (`id_estado_idioma_pk`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_idioma` (
  ...
  `modificado_por` INT NULL COMMENT 'En este campo se almacenará el id del usuario que efectuará la creación o modificación respectiva a est tabla. Nótese que estos campos no están relacionados como llave foránea a ninguna tabla, pero se establecerá la relación a manera de referencia.',
  `fecha_modificacion` DATE NULL,
  `id_estado_idioma_fk` INT NOT NULL,
  PRIMARY KEY (`id_idioma_pk`),
  INDEX `fk_tbl_estado_idioma_idx` (`id_estado_idioma_fk` ASC),
  CONSTRAINT `fk_tbl_estado_idioma`
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_congreso` (
  ...
  `descripcion_congreso` LONGTEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NULL DEFAULT NULL,
  `lugar` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NULL DEFAULT NULL,
  `coordenadas` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NULL DEFAULT NULL,
  `id_pais_fk` VARCHAR(2) NOT NULL,
  `logo_congreso` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NULL DEFAULT NULL,
  `lema` VARCHAR(200) NULL,
  `numero_cai` VARCHAR(25) NULL COMMENT 'Número de cuenta de banco asociada al Congreso para cuestiones de pagos y demás.',
  ...
  `fecha_cambio_costo_inscripcion` DATE NULL DEFAULT NULL,
  ...
  INDEX `fk_tbl_congreso_tbl_pais2_idx` (`id_pais_fk` ASC),
  CONSTRAINT `tbl_congreso_pais_fk`
    FOREIGN KEY (`id_pais_fk`)
    REFERENCES `dbCongresoceat`.`tbl_pais` (`id_pais_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `tbl_congreso_estado_congreso_fk`
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_linea_investigacion` (
  ...
  `abreviacion` VARCHAR(15) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_programa` (
  ...
  `estado_programa` TINYINT(1) NULL,
  `descripcion` LONGTEXT NULL,
  `creado_por` INT NULL COMMENT 'En este campo se almacenará el id del usuario que efectuará la creación o modificación respectiva a est tabla. Nótese que estos campos no están relacionados como llave foránea a ninguna tabla, pero se establecerá la relación a manera de referencia.',
  `fecha_creacion` DATE NULL,
  `modificado_por` INT NULL COMMENT 'En este campo se almacenará el id del usuario que efectuará la creación o modificación respectiva a est tabla. Nótese que estos campos no están relacionados como llave foránea a ninguna tabla, pero se establecerá la relación a manera de referencia.',
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_tipo_logs` (
  `id_tipo_log_pk` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_solicitud` (
  ...
  `status` TINYINT(1) NULL COMMENT '1: Aceptada\n0: Rechazada',
...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cuantitativas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cuantitativas` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cuantitativas` (
  `id_revisiones_trabajo_fk` INT NOT NULL,
  `id_respuesta_cuantitativa_fk` INT NOT NULL,
  PRIMARY KEY (`id_revisiones_trabajo_fk`, `id_respuesta_cuantitativa_fk`),
...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cualitativas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cualitativas` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_respuestas_revisiones_trabajos_cualitativas` (
  `id_revisiones_trabajo_fk` INT NOT NULL,
  `id_respuesta_cualitativa_fk` INT NOT NULL,
  PRIMARY KEY (`id_revisiones_trabajo_fk`, `id_respuesta_cualitativa_fk`),
  INDEX `id_respuesta_cualitativa_fk_idx` (`id_respuesta_cualitativa_fk` ASC),
  CONSTRAINT `tbl_revisiones_trabajo_fk`
    FOREIGN KEY (`id_revisiones_trabajo_fk`)
    REFERENCES `dbCongresoceat`.`tbl_revisiones_trabajo` (`id_revisiones_trabajo_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `tbl_respuesta_cualitativa_fk`
...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_congreso_tipo_trabajo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_congreso_tipo_trabajo` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_congreso_tipo_trabajo` (
  `id_congreso_fk` INT NOT NULL,
  `id_tipo_trabajo_fk` INT NOT NULL,
  PRIMARY KEY (`id_congreso_fk`, `id_tipo_trabajo_fk`),
  INDEX `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_tipo_trabajo1_idx` (`id_tipo_trabajo_fk` ASC),
  INDEX `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_congreso1_idx` (`id_congreso_fk` ASC),
  CONSTRAINT `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_congreso1`
    FOREIGN KEY (`id_congreso_fk`)
    REFERENCES `dbCongresoceat`.`tbl_congreso` (`id_congreso_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_tipo_trabajo1`
    FOREIGN KEY (`id_tipo_trabajo_fk`)
    REFERENCES `dbCongresoceat`.`tbl_tipo_trabajo` (`id_tipo_trabajo_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_solicitud_has_tbl_tematica`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_solicitud_has_tbl_tematica` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_solicitud_has_tbl_tematica` (
  `tbl_solicitud_id_solicitud` INT NOT NULL,
  `tbl_tematica_id_tematica_pk` INT NOT NULL,
  PRIMARY KEY (`tbl_solicitud_id_solicitud`, `tbl_tematica_id_tematica_pk`),
  INDEX `fk_tbl_solicitud_has_tbl_tematica_tbl_tematica1_idx` (`tbl_tematica_id_tematica_pk` ASC),
  INDEX `fk_tbl_solicitud_has_tbl_tematica_tbl_solicitud1_idx` (`tbl_solicitud_id_solicitud` ASC),
  CONSTRAINT `fk_tbl_solicitud_has_tbl_tematica_tbl_solicitud1`
    FOREIGN KEY (`tbl_solicitud_id_solicitud`)
    REFERENCES `dbCongresoceat`.`tbl_solicitud` (`id_solicitud`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_solicitud_has_tbl_tematica_tbl_tematica1`
    FOREIGN KEY (`tbl_tematica_id_tematica_pk`)
    REFERENCES `dbCongresoceat`.`tbl_tematica` (`id_tematica_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
