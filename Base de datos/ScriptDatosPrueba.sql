...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2017 a las 19:19:55
...
(1, 'Congreso de Economía Administración y Tecnología 2017', 'CEAT 2017', '5to Congreso de Economía, Administración y Tecnología ', 'Tegucigalpa, MDC. Universidad Nacional Autóno', NULL, '', 'ceat_2017.png', 'La responsabilidad social en la economía, administración y tecnología por medio de la Investigación, Desarrollo e Innovación', NULL, 2017, '2017-10-31', '2017-11-02', NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, '2017-07-11', 2),
(2, '1er Congreso de Comercio Internacional: Perspectivas de la Globalización', 'CCI 2017', 'Congreso de la Carrera de Comercio Internacional', 'Tegucigalpa, MDC. Universidad Nacional Autóno', NULL, '', 'cci.jpg', 'Perspectivas de la Globalización', NULL, 2017, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, '2017-07-12', 2),
(3, '1er Congreso Hondureño de Administración Pública: Abg Ramón Arturo Pineda Leiva', 'CAP 2017', 'Congreso de la Carrera de Administración Pública', 'Tegucigalpa, MDC. Universidad Nacional Autóno', NULL, '', 'cap.jpg', 'Innovando | Desarrollando | Sirviendo', NULL, 2017, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, '2017-07-11', 2),
(5, '1er Congreso Hondureño de Administración Valoración: Abg Eduardo Arturo Pineda Leiva', 'CAV 2017', 'Congreso de la Carrera de Valoracion Pública', 'Tegucigalpa, MDC. Universidad Nacional Autóno', NULL, '', 'cap.jpg', 'Innovando | Desarrollando | Sirviendo', NULL, 2017, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, '2017-07-11', 2);
...
INSERT INTO `tbl_idioma` (`id_idioma_pk`, `nombre_idioma`, `bandera`, `creado_por`, `fecha_creacion`, `modificado_por`, `fecha_modificacion`, `estado_idioma`) VALUES
...
(4, 'CAMBIO TECNOLÓGICO: INNOVACIÓN, INCUBACIÓN, ACELERACIÓN Y DESARROLLO', 'ct', 'sdsds', 'dds', 1, '2017-04-25', 2, '2017-07-10'),
...
ALTER TABLE `tbl_congreso`
  ADD PRIMARY KEY (`id_congreso_pk`,`id_pais_fk`),
...
--
ALTER TABLE `tbl_congreso`
  MODIFY `id_congreso_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada Congreso creado.', AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbl_log`
  MODIFY `id_log_pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
...
--
ALTER TABLE `tbl_usuario_congreso_roles`
  MODIFY `tbl_usuario_congreso_rol_pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `tbl_actividad_tematica`
  ADD CONSTRAINT `fk_tbl_actividad_has_tbl_tematica_tbl_actividad1` FOREIGN KEY (`id_actividad_fk`) REFERENCES `tbl_actividad` (`id_actividad_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_actividad_has_tbl_tematica_tbl_tematica1` FOREIGN KEY (`id_tematica_fk`) REFERENCES `tbl_tematica` (`id_tematica_pk`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_actividad_trabajo`
--
ALTER TABLE `tbl_actividad_trabajo`
  ADD CONSTRAINT `fk_tbl_actividad_has_tbl_trabajo_tbl_actividad1` FOREIGN KEY (`id_actividad_fk`) REFERENCES `tbl_actividad` (`id_actividad_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_actividad_has_tbl_trabajo_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_archivo_complementario`
--
ALTER TABLE `tbl_archivo_complementario`
  ADD CONSTRAINT `fk_tbl_archivos_complementarios_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_asignacion_editor_seccion_secundario`
  ADD CONSTRAINT `fk_tbl_asignacion_editor_seccion_secundario_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tbl_congreso`
  ...
  ADD CONSTRAINT `tbl_estado_congreso_congreso_fk` FOREIGN KEY (`id_estado_congreso_fk`) REFERENCES `tbl_estado_congreso` (`id_estado_congreso_pk`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `tbl_congreso_actividad`
--
ALTER TABLE `tbl_congreso_actividad`
  ADD CONSTRAINT `fk_tbl_congreso_actividad_tbl_linea_investigacion1` FOREIGN KEY (`id_linea_investigacion_pk`) REFERENCES `tbl_linea_investigacion` (`id_linea_investigacion_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_actividad_tbl_actividad1` FOREIGN KEY (`id_actividad_fk`) REFERENCES `tbl_actividad` (`id_actividad_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_actividad_tbl_congreso1` FOREIGN KEY (`id_congreso_fk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_congreso_linea_investigacion`
--
ALTER TABLE `tbl_congreso_linea_investigacion`
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_linea_investigacion_tbl_congreso1` FOREIGN KEY (`id_congreso_pk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_linea_investigacion_tbl_linea_investi1` FOREIGN KEY (`id_linea_investigacion_pk`) REFERENCES `tbl_linea_investigacion` (`id_linea_investigacion_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_congreso_tipo_trabajo`
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_congreso1` FOREIGN KEY (`id_congreso_fk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_congreso_has_tbl_tipo_trabajo_tbl_tipo_trabajo1` FOREIGN KEY (`id_tipo_trabajo_fk`) REFERENCES `tbl_tipo_trabajo` (`id_tipo_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_costo`
  ADD CONSTRAINT `fk_tbl_costo_tbl_roles_congreso1` FOREIGN KEY (`id_rol_congreso_fk`) REFERENCES `tbl_roles_congreso` (`tbl_rol_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_espacio_congreso`
--
ALTER TABLE `tbl_espacio_congreso`
  ADD CONSTRAINT `fk_tbl_espacio_has_tbl_congreso_tbl_congreso1` FOREIGN KEY (`id_congreso_fk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
ALTER TABLE `tbl_noticia`
  ADD CONSTRAINT `fk_tbl_noticia_tbl_usuario_congreso_roles1` FOREIGN KEY (`id_usuario_congreso_rol_fk`) REFERENCES `tbl_usuario_congreso_roles` (`tbl_usuario_congreso_rol_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_organizadores`
  ADD CONSTRAINT `fk_tbl_organizadores_tbl_congreso1` FOREIGN KEY (`id_congreso_fk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tbl_perfiles`
  ADD CONSTRAINT `fk_tbl_perfiles_tbl_usuario_congreso_roles1` FOREIGN KEY (`id_usuario_congreso_roles_fk`) REFERENCES `tbl_usuario_congreso_roles` (`tbl_usuario_congreso_rol_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_respuesta_mensaje`
  ADD CONSTRAINT `fk_tbl_respuesta_publicacion_tbl_publicacion1` FOREIGN KEY (`id_mensaje_fk`) REFERENCES `tbl_mensaje` (`id_mensaje`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tbl_roles_congreso`
  ADD CONSTRAINT `fk_tbl_roles_has_tbl_congreso_tbl_congreso1` FOREIGN KEY (`id_congreso_fk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tbl_solicitud`
  ADD CONSTRAINT `fk_tbl_solicitud_tbl_congreso1` FOREIGN KEY (`id_congreso_pk`) REFERENCES `tbl_congreso` (`id_congreso_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `tbl_trabajo`
  ...
  ADD CONSTRAINT `fk_tbl_trabajo_tbl_tematica1` FOREIGN KEY (`id_tematica_fk`) REFERENCES `tbl_tematica` (`id_tematica_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tbl_trabajo_tematica`
  ADD CONSTRAINT `fk_tbl_trabajo_has_tbl_tematica_tbl_tematica1` FOREIGN KEY (`id_tematica_fk`) REFERENCES `tbl_tematica` (`id_tematica_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tbl_trabajo_has_tbl_tematica_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_usuario_trabajo`
  ADD CONSTRAINT `fk_tbl_usuario_has_tbl_trabajo_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tbl_version_trabajo`
  ADD CONSTRAINT `fk_tbl_version_trabajo_tbl_trabajo1` FOREIGN KEY (`id_trabajo_fk`) REFERENCES `tbl_trabajo` (`id_trabajo_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
