...
--
-- Servidor: localhost
-- Tiempo de generación: 30-03-2017 a las 17:58:45
...
CREATE TABLE IF NOT EXISTS `tbl_congreso` (
  `id_congreso_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada Congreso creado.',
...
(1, 'Enviado a Revisión', 1, '2017-03-15', 1, '2017-03-15'),
...
CREATE TABLE IF NOT EXISTS `tbl_estado_congreso` (
  `id_estado_congreso_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identifcador único para cada estado de congreso',
...
CREATE TABLE IF NOT EXISTS `tbl_linea_investigacion` (
  `id_linea_investigacion_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tipo de linea de investigación',
...
CREATE TABLE IF NOT EXISTS `tbl_persona` (
  `id_persona_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada persona.',
...
CREATE TABLE IF NOT EXISTS `tbl_premio` (
  `id_premio_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único dado a cada premio',
...
CREATE TABLE IF NOT EXISTS `tbl_roles` (
  `id_rol_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada rol dentro del sistema',
...
CREATE TABLE IF NOT EXISTS `tbl_roles_congreso` (
  `tbl_rol_congreso_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para la indexación de ésta tabla.''',
...
CREATE TABLE IF NOT EXISTS `tbl_rtn` (
  `id_rtn_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para el ''RTN'' de cada individuo, persona u empresa con obligaciones tributarias hacia el Estado.',
...
CREATE TABLE IF NOT EXISTS `tbl_tarea_voluntario` (
  `id_tarea_voluntario_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tarea asociada a un voluntario. Ojo, éste campo no surje de la indexación porque esta no es una tabla transaccional, sino más bien la descripción de tareas que se asocian a los voluntarios.',
...
CREATE TABLE IF NOT EXISTS `tbl_telefono` (
  `id_telefono_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada número de teléfono',
...
CREATE TABLE IF NOT EXISTS `tbl_tematica` (
  `id_tematica_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único dado a cada tipo de temática.',
...
(2, 'xcxcvbcvxbxcvb', 1, 'cvbxcvb', 1, '2017-03-13', 1, '2017-03-13'),
(3, 'cxvbxcvbxcvbxcvbxcvbxcvbxcvbxvbxcvbxcvb', 1, 'vxcbxcvbxcvb', 1, '2017-03-13', 1, '2017-03-13');
...
CREATE TABLE IF NOT EXISTS `tbl_tipo_alimentacion` (
  `id_tipo_alimentacion_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tipo de alimentación',
...
CREATE TABLE IF NOT EXISTS `tbl_tipo_identificacion` (
  `id_tipo_identificacion_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tipo de identificación que será usado por cada usuario.',
...
(2, 'Resumen Extendico', 5, 1, '2017-03-13', 1, '2017-03-13', 5, 250);
...
CREATE TABLE IF NOT EXISTS `tbl_tipo_usuario` (
  `id_tipo_usuario_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tipo de usuario.',
...
CREATE TABLE IF NOT EXISTS `tbl_tour` (
  `id_tour_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada tour creado',
...
(1, 'xcvbxcvb', '2017-03-24', '../trabajos/congreso1/tipotrabajo1/1_2017-03-28_01-12-23eslistado-de-normas-para-programadores-del-proyecto-ceat.docx', 'xcvbvcb', 1, 1, 1, 0, 0, '10:00:00', 1, 'es', 'cvxbxcvb,cvbcvxb,cvbcxvb,cvxbcvb,xcvbxcvb', 'xcvbxcvb'),
(2, 'vbnvbn', '2017-03-24', '../trabajos/congreso1/tipotrabajo2/1_es_2017-03-28_01-18-12_listado-de-normas-para-programadores-del-proyecto-ceat.docx', 'cvbnvbn', 1, 1, 2, 0, 0, '10:00:00', 2, 'es', 'vbncvn,vbncvbncvbn', 'cvbncvbn'),
(3, 'vbnvbn', '2017-03-24', '../trabajos/congreso1/tipotrabajo1/1_es_2017-03-28_01-17-50_511-1680-1-rv.docx', 'cvbnvbn', 1, 1, 1, 0, 0, '10:00:00', 1, 'es', 'vbncvn,vbncvbncvbn', 'cvbncvbn');
...
CREATE TABLE IF NOT EXISTS `tbl_usuario` (
  `id_usuario_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único para cada usuario.',
  ...
  `contrasena` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT 'Contraseña que junto con el nombre_usuario (Nick) controlan el login',
   `img_usuario` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT,
...
INSERT INTO `tbl_usuario` (`id_usuario_pk`, `nombre_usuario`, `contrasena`, `id_persona_fk`, `id_idioma_fk`) VALUES
(1, 'jrodriguez', '$1$/t4.az4.$x9mTPpkx4uWvXiDAhX5zA.', 1, 'es'),
(2, 'alexvargas', '$1$3g..OR4.$s7XhcLBiyugnezFaJvi.m1', 2, 'es'),
(3, 'omartinez', '$1$r90.YJ3.$nuaGpjqJJyGcZqL8PFeZC.', 3, 'es');
...
CREATE TABLE IF NOT EXISTS `tbl_voluntario` (
  `id_voluntario_pk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único asociado a cada voluntario',
