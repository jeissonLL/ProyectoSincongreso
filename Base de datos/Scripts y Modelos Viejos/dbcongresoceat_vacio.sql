...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_congreso` (
  ...
  `descripcion_congreso` LONGTEXT NULL,
  ...
  `fecha_cambio_costo_inscripcion` DATE NULL,
  `logo_congreso` VARCHAR(45) NULL,
  ...
  INDEX `fk_tbl_congreso_tbl_pais1_idx` (`id_pais_fk` ASC),
  CONSTRAINT `fk_tbl_congreso_tbl_estado_congreso1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_congreso_tbl_pais1`
    FOREIGN KEY (`id_pais_fk`)
    REFERENCES `dbCongresoceat`.`tbl_pais` (`id_pais_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_respuesta_cuantitativa` (
  ...
  `id_trabajo_fk` INT NOT NULL,
  `tbl_usuario_id_usuario_fk` INT NOT NULL,
  ...
  INDEX `fk_tbl_respuestas_cuantitativas_tbl_trabajo1_idx` (`id_trabajo_fk` ASC),
  INDEX `fk_tbl_respuestas_cuantitativas_tbl_usuario1_idx` (`tbl_usuario_id_usuario_fk` ASC),
  CONSTRAINT `fk_tbl_respuestas_cuantitativas_tbl_preguntas_cuantitativas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_respuestas_cuantitativas_tbl_trabajo1`
    FOREIGN KEY (`id_trabajo_fk`)
    REFERENCES `dbCongresoceat`.`tbl_trabajo` (`id_trabajo_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_respuestas_cuantitativas_tbl_usuario1`
    FOREIGN KEY (`tbl_usuario_id_usuario_fk`)
    REFERENCES `dbCongresoceat`.`tbl_usuario` (`id_usuario_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_respuesta_cualitativa` (
  ...
  INDEX `fk_tbl_respuestas_cualitativas_tbl_trabajo1_idx` (`id_trabajo_fk` ASC),
  INDEX `fk_tbl_respuestas_cualitativas_tbl_usuario1_idx` (`id_usuario_fk` ASC),
  CONSTRAINT `fk_tbl_respuestas_cualitativas_tbl_preguntas_cualitativas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_respuestas_cualitativas_tbl_trabajo1`
    FOREIGN KEY (`id_trabajo_fk`)
    REFERENCES `dbCongresoceat`.`tbl_trabajo` (`id_trabajo_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_respuestas_cualitativas_tbl_usuario1`
    FOREIGN KEY (`id_usuario_fk`)
    REFERENCES `dbCongresoceat`.`tbl_usuario` (`id_usuario_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_asignacion_a_revisor` (
  ...
  `termino_llenar_formulario` TINYINT(1) NULL,
  `fecha_que_reviso` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_mensaje` (
  `id_mensaje_pk` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_respuesta_mensaje` (
  `id_respuesta_mensaje_pk` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `dbCongresoceat`.`tbl_congreso_patrocinador`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbCongresoceat`.`tbl_congreso_patrocinador` ;

CREATE TABLE IF NOT EXISTS `dbCongresoceat`.`tbl_congreso_patrocinador` (
  `id_congreso_fk` INT NOT NULL,
  `id_patrocinador_fk` INT NOT NULL,
  PRIMARY KEY (`id_congreso_fk`, `id_patrocinador_fk`),
  INDEX `fk_tbl_congreso_has_tbl_patrocinador_tbl_patrocinador1_idx` (`id_patrocinador_fk` ASC),
  INDEX `fk_tbl_congreso_has_tbl_patrocinador_tbl_congreso1_idx` (`id_congreso_fk` ASC),
  CONSTRAINT `fk_tbl_congreso_has_tbl_patrocinador_tbl_congreso1`
    FOREIGN KEY (`id_congreso_fk`)
    REFERENCES `dbCongresoceat`.`tbl_congreso` (`id_congreso_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_congreso_has_tbl_patrocinador_tbl_patrocinador1`
    FOREIGN KEY (`id_patrocinador_fk`)
    REFERENCES `dbCongresoceat`.`tbl_patrocinador` (`id_patrocinador_pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
