...
<div class="row">
    <div class="col-md-12">
        <div>
            <div class="card-box">
                <section>
                    <h4 class="m-t-0 page-header header-title m-b-30 m-b-30"><b>41 New Icons in 4.7 </b><span class="label label-primary">New</span></h4>
                ...
                <section>
                    <h4 class="page-header header-title m-b-30"><b>30 New Icons in 4.6.3 </b></h4>
                    <div class="icon-list-demo row">
               ...
               <section>
                ...
                <section id="spinner">
                    ...
                    <div class="row icon-list-demo">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-gear"></i> fa-gear <span class="text-muted">(alias)</span>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="m-b-30">
                        ...
                        <i class="fa fa-shield m-r-5"></i> normal<br>
                        <i class="fa fa-shield fa-rotate-90 m-r-5"></i> fa-rotate-90<br>
                        <i class="fa fa-shield fa-rotate-180 m-r-5"></i> fa-rotate-180<br>
                        <i class="fa fa-shield fa-rotate-270 m-r-5"></i> fa-rotate-270<br>
                        <i class="fa fa-shield fa-flip-horizontal m-r-5"></i> fa-flip-horizontal<br>
                        <i class="fa fa-shield fa-flip-vertical m-r-5"></i> icon-flip-vertical
                    </div>
                </div>
