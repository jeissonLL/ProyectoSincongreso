...
<footer class="footer text-right">
    <span id="anio"></span> &copy; CEAT - IIES - UNAH
</footer>
<!-- End FOOTER -->
...
<script src="./js/gestion_traducciones_js/clicks_cambio_pantalla.js"></script>
<script src="./js/gestion_congresos_js/clicks_cambio_pantalla.js"></script>