...
class Congreso {
    ...
    public function crear_congreso() {
        $datos   =   $this->base->insert("INSERT INTO tbl_congreso(nombre_congreso, siglas, descripcion_congreso, lugar, coordenadas,
         id_pais_fk, logo_congreso, lema, numero_cai, anio, fecha_inicio, fecha_finalizacion, fecha_i_recepcion, fecha_f_recepcion,
          fecha_i_revision, fecha_f_revision, fecha_p_programa, fecha_cambio_costo_inscripcion, id_estado_congreso_fk, creado_por,
           fecha_creacion) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", "ssssssssssssssssssiis", 
           [$this->nombre_congreso, $this->siglas, $this->descripcion_congreso, $this->lugar, $this->coordenadas, 
           $this->id_pais_fk, "", $this->lema, $this->numero_cai, $this->anio, $this->fecha_inicio, $this->fecha_finalizacion, 
           $this->fecha_i_recepcion, $this->fecha_f_recepcion, $this->fecha_i_revision, $this->fecha_f_revision, $this->fecha_p_programa,
            $this->fecha_cambio_costo_inscripcion, 2, $this->idusuario_cm, date("y-m-d")], TRUE);
        if(   $datos   >   0   ) {
