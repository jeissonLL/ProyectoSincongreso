...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <div id="div_total_trabajos" class="widget-simple-chart text-right card-box">
        </div>
    </div>

    <div class="col-sm-6 col-lg-3">
        <div id="div_total_registrados" class="widget-simple-chart text-right card-box">
        </div>
    </div>

    <div class="col-sm-6 col-lg-3">
        <div id="div_total_taceptados" class="widget-simple-chart text-right card-box">
        </div>
    </div>

    <div class="col-sm-6 col-lg-3">
        <div id="div_total_trechazados" class="widget-simple-chart text-right card-box">
        </div>
    </div>
</div>
<!-- end row -->
...
<div class="row">
    <div class="col-lg-4">
        <div class="card-box">
            <h4 class="text-dark  header-title m-t-0 m-b-30">@@trabajosxtematica@@</h4>

            <div class="widget-chart text-center">
                <div id="total_x_tematica"></div>
<!--                <ul class="list-inline m-t-15">
    ...
    <div class="col-lg-4">
        <div class="card-box">
            <h4 class="text-dark  header-title m-t-0 m-b-30">@@total_x_usuario_x_carrera@@</h4>

            <div class="widget-chart text-center">
                <div id="total_x_usuario_x_carrera"></div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card-box">
            <h4 class="text-dark header-title m-t-0 m-b-30">@@trabajosxlinea@@</h4>

            <div class="widget-chart text-center">
                <div id="total_x_linea"></div>
<!--                <ul class="list-inline m-t-15">
                    <li>
                        <h5 class="text-muted m-t-20">Target</h5>
                        <h4 class="m-b-0">$1000</h4>
