        ...
        <form enctype="multipart/form-data" method='POST' name='c_itineario'  id='c_itineario' class='form-horizontal form-bord forered' data-parsley-validate='true'> 
         <div class="col-sm-12" align="center">
            ...
            <p class="text-muted m-b-30 font-13"></p> <!---->
                    <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>@@crear_itinerario@@</b></h4>
                                <p class="text-muted m-b-30 font-13"></p> 
                                <div class="panel">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="panel-body">
                                             <table class="table table-striped" id="tbl_asis_c_itineraio" >
                                                <thead>
                                        ...
                                        <ul class="pager m-b-0 wizard">
                                            <li class="next"><a  id="crear_itinerario_asistente"   class="btn btn-primary waves-effect waves-light">@@crear_itinerario@@</a></li>
                                        </ul>
