...
/*
 * Archivo visualizacion del programa 
        ...
        <form enctype="multipart/form-data" method='POST' name='c_programa'  id='c_programa' class='form-horizontal form-bord forered' data-parsley-validate='true'> 
         <div class="col-sm-12" align="center">
            ...
            <p class="text-muted m-b-30 font-13"></p> <!---->
                    <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>@@c_programa@@</b></h4>
                                <p class="text-muted m-b-30 font-13"></p> 
                                <div class="panel">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="panel-body">
                                             <table class="table table-striped" id="tbl_asis_programa" >
                                                <thead>
                                        ...
                                        <ul class="pager m-b-0 wizard">
                                            <li class="next"><a  id="descargar_programa"  href="form/gestion_asistente/plantillas/descargar_programa.php" target="_blank" class="btn btn-primary waves-effect waves-light">@@descargar_programa@@</a></li>
                                        </ul>
...
<script>
function doSearch() {
    var tableReg = document.getElementById('tbl_asis_programa');
