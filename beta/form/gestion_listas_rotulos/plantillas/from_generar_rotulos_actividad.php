...
/*
 * Archivo generar rotulos por actividades
...
<div class="row">   
        <form enctype="multipart/form-data" method='POST' name='g_listas_rotulos'  id='g_listas_rotulos' class='form-horizontal form-bord forered' data-parsley-validate='true'> 
         <div class="col-sm-12" align="center">
            ...
            <p class="text-muted m-b-30 font-13"></p> <!---->
                    <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>@@rotulos_actividad@@</b></h4>
                                <p class="text-muted m-b-30 font-13"></p> 
                                <div class="panel">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="panel-body">
                                         ...
                                         <input type="hidden" id="enlace"  value="">
                                        <ul class="pager m-b-0 wizard">
                                           
                                            <li class="next"><a  id="generar_rotulo"  href="form/gestion_listas_rotulos/plantillas/rotulos_actividad.php?actividad=2"  target="_blank" class="btn btn-primary waves-effect waves-light">@@generar_listas_actividad@@</a></li>
                                        </ul>
