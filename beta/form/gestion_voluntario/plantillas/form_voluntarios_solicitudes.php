                            ...
                            <div class="card-box">
			                    ...
			                    <label>@@buscar@@:
			                        <input type="search" id="buscar" onkeyup="doSearch()" class="form-control input-sm" placeholder="" aria-controls="tbl_form_tem">
                                            ...
                                            <table class="table table-striped" id="tbl_solicitudes_voluntarios" name="tbl_solicitudes_voluntarios">
                                                <thead>
...
<script>
function doSearch() {
    var tableReg = document.getElementById('tbl_solicitudes_voluntarios');
