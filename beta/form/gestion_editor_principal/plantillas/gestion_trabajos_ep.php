...
/*
 * Archivo formulario de creaci贸n formularios 
    ...
    <div class="col-sm-12" align="center">
            ...
            <p class="text-muted m-b-30 font-13"></p> <!---->
					...
					<div class="form-group clearfix" >
			                <label class="col-md-1 control-label">@@linea@@</label>
			                <div class="col-md-4">
			                    <select class="form-control" id="lineas_investigacion" onchange="muestra_tematica()" >
			                    </select>
			                </div>
			                
			                <div id="tematicas_filtradas0">
			                    
			                </div>
			                
			                <div id="temataticas1" style="display: none" > 
			                   <label class="col-md-2 control-label">@@tematica@@</label>
			                   <div class="col-md-4">
			                       <select class="form-control" id="tematicas_trabajo"  >
			                       </select>
			                   </div>
			                </div>
			            </div>
			                ...
			                <div id="tbl_form_tem_filter" class="dataTables_filter">
			                    <label>@@buscar@@:
			                        <input type="search" id="buscar" onkeyup="doSearch()" class="form-control input-sm" placeholder="" aria-controls="tbl_form_tem">
                                            ...
                                            <table class="table table-striped" id="tbl_trabajos_ep" name="tbl_trabajos_ep">
                                                <thead>
                                                 <tr class="alert alert-success">
				                    <th width="3%">@@num@@ </th>
				                    <th width="20%">@@titulo_trabajo@@ </th>
				                    <th width="15%">@@palabrasclave@@</th>
                        ...
                        <div class='modal-dialog' id="modal_revisores1" >
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-footer'>
                                            ...
                                            <a type='button' id="btn_asignar_revisor" onclick="asignar_revisor_trabajo()" class='btn btn-sm btn-success btn-rounded'>@@btn_guardar@@</a>
                                        </div>
                                    </div>
                        </div>                                    
        </div>
