...
/*
 * Dictaminar trabajos editor principal
 * Autor: Obed Martinez
 * fecha: 20/06/17
 */
                            ...
                            <div class="card-box">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">                                       
                                            <table class="table table-striped" id="tbl_dictaminar_trabajos_ep" name="tbl_dictaminar_trabajos_ep">
                                                <thead>
                                                <tr class='alert alert-success'>
                                                    <th width="3%%" >@@num@@</th>
                                                    <th width="25%"  >@@titulo_trabajo@@</th> 
                                                    <th width="20%" >@@tematica_trabajo@@</th> 
                                                    <th width="10%" style="text-align: center;">@@tipo_trabajo@@</th>
                                                    <th width="10%" style="text-align: center;">@@idioma@@</th>
...
<!--                                             <div class="modal-header">
                                        ...
                                        <div class='modal-footer'>
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">@@btn_cerrar@@</button>
                                                <button type="button" class="btn btn-success waves-effect" id="btn_guardar" >@@btn_guardar@@</button>
                                        </div>
                                    </div>
                        </div>                                    
                </div>
...
<script src="./js/gestion_editor_principal/gestion_trabajos_ep.js"></script>
